...
/**
 * Custom implementation by RedstoneTek (Toon Link)
 */
public class CBCommandClientBuilder
{
    private Game game = Game.playing("default");
    private OnlineStatus status = OnlineStatus.ONLINE;
    private String ownerId;
    private String[] coOwnerIds;
    private IGetPrefix prefix;
	...
	private Predicate<User> canCommand;
	private Consumer<CommandEvent> genericCommand;
    ...
    {
        CommandClient client = new CBCommandClientImpl(ownerId, coOwnerIds, prefix, altprefix, game, status, serverInvite,
     ...
     * @return This builder
     */
    public CBCommandClientBuilder setOwnerId(String ownerId)
    {
     ...
     * @return This builder
     */
    public CBCommandClientBuilder setCoOwnerIds(String... coOwnerIds)
    {
     ...
     * @return This builder
     */
    public CBCommandClientBuilder setPrefix(IGetPrefix prefix)
    {
        this.prefix = prefix;
        return this;
    }
     ...
     * @return This builder
     */
    public CBCommandClientBuilder setAlternativePrefix(String prefix)
    {
     ...
     * @return This builder
     */
    public CBCommandClientBuilder useHelpBuilder(boolean useHelp)
    {
     ...
     * @return This builder
     */
    public CBCommandClientBuilder setHelpConsumer(Consumer<CommandEvent> helpConsumer)
    {
     ...
     * @return This builder
     */
    public CBCommandClientBuilder setHelpWord(String helpWord)
    {
     ...
     * @return This builder
     */
    public CBCommandClientBuilder setServerInvite(String serverInvite)
    {
     ...
     * @return This builder
     */
    public CBCommandClientBuilder setEmojis(String success, String warning, String error)
    {
     ...
     * @return This builder
     */
    public CBCommandClientBuilder setGame(Game game)
    {
        this.game = game;
        return this;
    }
     ...
     * @return This builder
     */
    public CBCommandClientBuilder useDefaultGame()
    {
     ...
     * @return This builder
     */
    public CBCommandClientBuilder setStatus(OnlineStatus status)
    {
        this.status = status;
        return this;
    }
     ...
     * @return This builder
     */
    public CBCommandClientBuilder addCommand(Command command)
    {
     ...
     * @return This builder
     */
    public CBCommandClientBuilder addCommands(Command... commands)
    {
     ...
     */
    public CBCommandClientBuilder addAnnotatedModule(Object module)
    {
     ...
     * @see    com.jagrosh.jdautilities.command.annotation.JDACommand
     */
    public CBCommandClientBuilder addAnnotatedModules(Object... modules)
    {
     ...
     * @see    com.jagrosh.jdautilities.command.annotation.JDACommand
     */
    public CBCommandClientBuilder setAnnotatedCompiler(AnnotatedModuleCompiler compiler)
    {
     ...
     * @return This builder
     */
    public CBCommandClientBuilder setCarbonitexKey(String key)
    {
        this.carbonKey = key;
        return this;
    }
     ...
     * @return This builder
     */
    public CBCommandClientBuilder setDiscordBotsKey(String key)
    {
        this.botsKey = key;
        return this;
    }
     ...
     */
    @Deprecated
    public CBCommandClientBuilder setDiscordBotListKey(String key)
    {
        // this.botsOrgKey = key;
        return this;
    }
     ...
     * @return This builder
     */
    public CBCommandClientBuilder setListener(CommandListener listener)
    {
     ...
     * @return This builder
     */
    public CBCommandClientBuilder setScheduleExecutor(ScheduledExecutorService executor)
    {
     ...
     * @return This builder
     */
    public CBCommandClientBuilder setShutdownAutomatically(boolean shutdownAutomatically)
    {
     ...
     * @return This builder
     */
    public CBCommandClientBuilder setLinkedCacheSize(int linkedCacheSize)
    {
     ...
     * @return This builder
     */
    public CBCommandClientBuilder setGuildSettingsManager(GuildSettingsManager<?> manager)
    {
        this.manager = manager;
        return this;
    }
    
    public CBCommandClientBuilder setCanCommand(Predicate<User> canCommand) {
		this.canCommand = canCommand;
		return this;
	}
    
    public CBCommandClientBuilder setGenericCommand(Consumer<CommandEvent> genericCommand) {
